export const personalTools: { title: string; href: string; description: string }[] = [
    {
      title: "Dashboard",
      href: "/",
  ...
  export const administrativeTools: { title: string; href: string; description: string }[] = [
    {
      title: "Address Book",
      href: "/addressbook",
...
export const salesComponents: { title: string; href: string; description: string }[] = [
    {
...
export const lettingsComponents: { title: string; href: string; description: string }[] = [
    {
      title: "Properties",
...
export const marketingComponents: { title: string; href: string; description: string }[] = [
    {
      title: "Portals",
      href: "/portals",
      description:
        "Select the portal accounts to be included in the export."
    },
    {
      title: "Social Media",
      href: "/social-media",
      description:
        "Get the social media accounts for the properties."
    },
    {
      title: "Board Management",
      href: "/board-management",
      description:
        "Board management for the properties."
    }
    
  ]
  
export const adminComponents: { title: string; href: string; description: string }[] = [
    {
      title: "Company",
      href: "/company",
      description:
...
export const templatesComponents: { title: string; href: string; description: string }[] = [
    {
      title: "Letters & Emails",
      href: "/letters-and-emails",
      description:
        "Manage the letters and emails for the system."
    },
    {
      title: "Documents",
      href: "/documents",
      description:
        "Manage the documents for the system."
    },
    {
      title: "Other",
      href: "/other",
      description:
        "Manage the other templates for the system."
    },
    {
      title: "Images",
      href: "/images",
      description:
        "Manage the images for the system."
    },
    {
      title: "Checklists",
      href: "/checklists",
      description:
        "Manage the checklists for the system."
    }
  ]